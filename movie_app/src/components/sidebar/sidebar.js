        ...
        return(
            <div className="col-sm-3 col-md-2 sidebar">
                <ul className="nav nav-sidebar">
                    <li className="active"><Link to="/" activeClassName="active">Dashboard</Link></li>
                    <br/>
                    ...
                    <li><Link to="/widgets" activeClassName="active">Lowest Rated</Link></li>
                    <br/>
                    <li><Link to="/widgets" activeClassName="active">TV</Link></li>
                    <img src={require('../../images/blue_line.png')}/>
                    <li><Link to="/widgets" activeClassName="active">Most Popular</Link></li>
                    <li><Link to="/widgets" activeClassName="active">Top Rated</Link></li>
                    <br/>
                    <li><Link to="/widgets" activeClassName="active">Celebs</Link></li>
